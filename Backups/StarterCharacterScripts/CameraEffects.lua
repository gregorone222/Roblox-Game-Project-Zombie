...
-- Inisialisasi VFX Timeout Boss 2
local ReplicatedStorage = game:GetService("ReplicatedStorage")
local Boss2TimeoutVFX = require(ReplicatedStorage:WaitForChild("ZombieVFX"):WaitForChild("Boss2TimeoutVFX"))
Boss2TimeoutVFX.init()
