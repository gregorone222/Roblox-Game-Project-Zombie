...
function LobbyBuilder.Build()
	...
	createPart("CommandTable", Vector3.new(8, 2.5, 5), CFrame.new(0, GROUND_LEVEL + 1.8, 78), gazebo, COLORS.WoodLight, Enum.Material.Wood)
	...
	print("LobbyBuilder: Farmhouse Lobby Built! 🏠✨")
end
