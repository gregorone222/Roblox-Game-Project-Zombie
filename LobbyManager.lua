...
local function ensureRemote(parent, name, className)
	...
	return existing-- LobbyManager.lua (Script)
-- Path: ServerScriptService/Script/LobbyManager.lua
-- Script Place: Lobby
...
local function onPlayerAdded(player)
	...
	task.spawn(function()
		...
		-- Auto-open Daily Reward jika bisa klaim
		local success, state = pcall(function() return DailyRewardManager:GetPlayerState(player) end)
		if success and state and state.CanClaim then
