...
### Fog (Kabut)
Digunakan secara agresif untuk:
1.  **Optimasi:** Menyembunyikan rendering jarak jauh.
2.  **Horor:** Menciptakan rasa ketidakpastian dan klaustrofobia.
3.  **Estetika:** Membangun mood sesuai tema map (Subway vs Village).
