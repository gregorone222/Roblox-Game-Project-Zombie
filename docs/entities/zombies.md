...
### 1. Plague Titan (Wave 10)
- **Module:** `Boss1Module`
- **HP:** 75,000
- **Type:** Tank besar
- **Attacks:** Serangan area asam dan radiasi (Corrosive Slam, Toxic Lob)
- **Strategy:** Fokus hindari area damage, serang saat jeda

### 2. The Hive Mother (Wave 30)
- **Module:** `Boss2Module`
- **HP:** 100,000
- **Type:** Summoner
- **Attacks:** Memanggil larva, menyebarkan awan racun (Acid Spit, Toxic Cloud)
- **Strategy:** Prioritaskan adds, jaga jarak dari awan

### 3. The Blighted Alchemist (Wave 50)
- **Module:** `Boss3Module`
- **HP:** 125,000
- **Type:** Dalang (Final Boss Act 1)
- **Attacks:** Serangan kimia volatil, eksperimen mutasi (Syringe Volley, Plague Bomb)
- **Strategy:** Fase-fase serangan, timing penting
